      ...
      <div className="w-full bg-[#65bcae]">
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 h-10 flex items-center justify-between">
          ...
          <div className="flex h-full items-center pl-4 sm:pl-0">
            ...
            <a href="https://pinterest.com/Stetchlies/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-full bg-[#e83e8c] text-white hover:bg-[#d8327d] transition-colors">
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20">
          ...
          <div className="flex h-20 items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3 group py-1">
              ...
              />
              <div className="flex">
                <span className="font-sans text-[28px] sm:text-4xl font-black tracking-tight text-[#32174d] group-hover:opacity-90 transition-opacity">
                  STETCH
                </span>
                <span className="font-sans text-[28px] sm:text-4xl font-black tracking-tight text-[#e83e8c] group-hover:opacity-90 transition-opacity">
                  LIES
                </span>
              </div>
            </Link>
